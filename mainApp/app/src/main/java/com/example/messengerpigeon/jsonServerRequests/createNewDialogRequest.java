 ...
 */
public class createNewDialogRequest  extends jsonServerRequests {
    /**
     ...
     */
    public void createRequest(String token,String nameDialog, String id) throws JSONException {
        JSONObject obj = new JSONObject();
        JSONObject req = new JSONObject();
        req.put("token", token);
        req.put("dialogName", nameDialog);
